...
class Game:
    ...
    def turn(self, _choice=None):
        ...
        """
        """
        Recalcule le nombre de chaque joueur, et la somme mod 6
    ...
    def clue(self, clue):
        ...
        for i in range(5):
            somme_joueurs.append((somme-liste_joueur[i])%8)
        #Il faut maintenant que chaque joueur puisse déduire son nombre
        nombres_deduits = []
        for i in range(5):
            ndeduit = somme_joueurs[0] - #Il faut reconstituer le nombre de chaque joueur à partir de la somme mod 8 et des nombres qu'ils connaissent

            #Il faut ensuite flag les cartes en
